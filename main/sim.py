...
class Simulator:
    ...
    def save_results(self, output_filepath="results_attribute_aware_50_agents.csv"):
...
if __name__ == "__main__":
    ...
    with open("results_attribute_aware_50_agents.csv", 'r') as f:
