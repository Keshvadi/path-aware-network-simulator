...
class Simulator:
    ...
    def save_results(self, output_filepath="results_with_loss_min_rtt_100_agents.csv"):
...
if __name__ == "__main__":
    ...
    STRATEGY =  "min_rtt" #"attribute_aware" #"min_rtt" #"min_load" 
    ...
    with open("results_with_loss_min_rtt_100_agents.csv", 'r') as f:
